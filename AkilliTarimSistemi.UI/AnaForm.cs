    ...
    public partial class AnaForm : Form
    {
        ...
        private async void AnaForm_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Veritabanı otomatik geçiş kontrolü
                if (_serviceProvider != null)
                {
                    using (var scope = _serviceProvider.CreateScope())
                    {
                        var context = scope.ServiceProvider.GetRequiredService<AkilliTarimDbContext>();
        ...
        private void btnTahminOneri_Click(object? sender, EventArgs? e) => FormGetirVeGoster<TahminForm>();
